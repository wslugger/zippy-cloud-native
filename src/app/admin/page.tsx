    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div>
                ...
                <p className="text-slate-400">Manage the technical core of Zippy Networks.</p>
            </div>

            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                {stats.map((stat) => (
                    <div key={stat.name} className="p-6 rounded-xl bg-slate-900 border border-slate-800 shadow-sm transition-all hover:border-slate-700">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <div className="col-span-4 p-6 rounded-xl bg-slate-900 border border-slate-800">
                    <h3 className="text-lg font-semibold mb-4">Quick Actions</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <Link href="/admin/taxonomy" className="group p-4 rounded-lg bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50 border-dashed transition-all">
                        ...
                        <Link href="/admin/prompts" className="group p-4 rounded-lg bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50 border-dashed transition-all">
                            <div className="flex items-center justify-between">
                ...
                <div className="col-span-3 p-6 rounded-xl bg-slate-900 border border-slate-800">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="text-slate-200">v7.0.0 (Adapter-PG)</span>
                        </div>
                        <div className="flex items-center justify-between text-sm">
