    ...
    return (
        <div className="flex flex-col space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-white">Catalog Items</h2>
                    <p className="text-slate-400">Manage hardware, software, and services inventory.</p>
                </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1">
                    ...
                    <Input
                        ...
                        className="pl-10 bg-slate-900 border-slate-800 focus:ring-blue-500/20"
                        value={search}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    ...
                    items.map((item) => (
                        <div
                            key={item.id}
                            className="bg-slate-900/50 border border-slate-800 rounded-2xl p-5 hover:border-blue-500/30 transition-all group overflow-hidden relative"
                        >
                            {/* Type Badge */}
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-2 px-2 py-1 bg-slate-950 rounded-lg border border-slate-800">
                    ...
                    <div className="col-span-full h-64 flex flex-col items-center justify-center text-slate-600 gap-4 border-2 border-dashed border-slate-800 rounded-3xl">
